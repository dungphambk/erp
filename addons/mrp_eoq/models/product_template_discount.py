...
class ProductTemplate(models.Model):
    ...
    @api.depends('price_1', 'minimum_amount_1')
    ...
    @api.depends('price_2', 'minimum_amount_2')
    ...
    @api.depends('price_3', 'minimum_amount_3')
    ...
    def _compute_optimal_price(self):
        for product_template in self:
            #Chưa compare với giá gốc, khi chưa có cost 3 thì đang chạy là 0
